        ...
        <div className='mb-24'>
            ...
            <div className='md:grid md:grid-cols-2 lg:gap-16 md:gap-12 lg:mx-24 md:mx-6'>
                ...
                <div className='xl:mt-16 text-white text-center md:text-left'>
                    <p className='mt-4 mx-2 md-mt-0 md:mx-0 lg:text-xl xl:text-2xl'>Update the Inventory with full of new Bikes. All newly released news are just one step away from here. Click the button bellow.</p>
                    <Link to='#'>
