                ...
                <div className="rounded-lg shadow ">
                    <div className='w-full md:w-3/4 2xl:w-1/2 mx-auto'>
                        <div className='flex bg-white'>
                            ...
                            <div className='w-2/12 flex items-center justify-center border-[1px] md:border-2 border-gray-100'>
                                <button type="button" data-modal-toggle="popup-modal" onClick={() => handleDeleteItem(_id)} className='p-1.5 text-xs font-bold uppercase md:tracking-wider text-rose-800 bg-rose-400 rounded-lg bg-opacity-50 hover:bg-rose-500'>Delete</button>
                            </div>
