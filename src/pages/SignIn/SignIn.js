                ...
                <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div className='flex justify-between mt-5'>
                        <button onClick={forgetPassword}
                         className="inline-block align-baseline font-bold text-blue-500 hover:text-blue-800" href="#">
                            Forgot Password?
                        </button>
                        <p>Don't have an account?</p>
                        <Link to='/signup' className="inline-block align-baseline font-bold text-blue-500 hover:text-blue-800">
                            Register?
                        </Link>
                    </div>
                    {errorElement}
